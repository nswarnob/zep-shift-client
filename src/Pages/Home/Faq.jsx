...
// import { IoHelpCircle, IoChevronDown } from "react-icons/io5";
const Faq = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "A cellphone monthly invoice is typically payment due during a specified 15 to 3 month(s) 3 back, and will be automatically paid by 'on-demand' deposit (equivalent to the crypto form) from your Fiat Money. It will be directly deposited within 3 to 5 days depending upon a possible supply in the checking account.",
    },
    {
      question: "Is it available for all age group/child/type?",
      answer:
        "Our service is available for users of all ages. However, some features may require parental consent for minors under 18 years old.",
    },
    {
      question: "Does it modify body the head post and prepay/buy repayment?",
      answer:
        "No, our system maintains all original payment structures and does not modify the principal or repayment terms without your explicit authorization.",
    },
    {
      question: "What if the user wallet has low low balances initially?",
      answer:
        "If your wallet balance is insufficient, you'll receive a notification to add funds. Transactions will be queued until sufficient balance is available.",
    },
    {
      question: "How will be verified when the product is made or sold?",
      answer:
        "All transactions are verified through blockchain technology, providing transparent and immutable records of each sale or purchase.",
    },
  ];
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Choose a question from the list below to see the answer. If your
            question isn't answered here, you can email us and we'll get back to
            you as soon!
          </p>
        </div>
